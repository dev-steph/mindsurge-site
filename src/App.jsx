...
function App() {
  ...
  const features = [
    ...
    {
      icon: <Smartphone className="w-6 h-6 text-[#4F8EF7] dark:text-emerald-400" />,
  ...
  const isNavScrolled = scrollY > 20;
  const navLinkClass = isNavScrolled && !isDark 
    ? "text-sm font-medium text-light-text-secondary hover:text-light-text-primary transition"
    : "text-sm font-medium text-slate-300 hover:text-white transition";
  const navBtnClass = isNavScrolled && !isDark
    ? "p-2 rounded-full text-light-text-secondary hover:text-light-text-primary hover:bg-light-surface-variant transition-all border border-transparent hover:border-light-border"
    : "p-2 rounded-full text-slate-300 hover:text-white hover:bg-white/10 transition-all border border-transparent hover:border-white/10";
  ...
  return (
    <div className={`min-h-screen selection:bg-blue-500/30 selection:text-blue-200 overflow-x-hidden font-sans ${isDark ? 'dark bg-[#0A0E1A] text-slate-100' : 'bg-light-bg text-light-text-primary'}`}>
      {/* Page Level Glows (Dark Mode Only) */}
      ...
      <motion.nav 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isNavScrolled 
            ? 'bg-light-surface/90 dark:bg-[#0A0E1A]/85 backdrop-blur-md border-b border-light-border dark:border-slate-800/80 py-4 shadow-sm dark:shadow-black/10' 
            : 'bg-transparent py-6'
        }`}
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <a href="#" className="flex items-center gap-3 group">
            <div className="relative">
              ...
              <img src={logoImg} alt="MindSurge Logo" className="w-10 h-10 rounded-xl relative border border-white/10 shadow-md shadow-blue-500/10" />
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#showcase" className={navLinkClass}>App Preview</a>
            <a href="#roadmap" className={navLinkClass}>Roadmap</a>
            <a href="#project-status" className={navLinkClass}>Development Status</a>
            <button 
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-[#4F8EF7] hover:bg-blue-500 text-white shadow-lg shadow-blue-500/25 flex items-center gap-1.5 transition-all hover:scale-[1.02]"
            >
              Open Web Portal
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            className="fixed inset-0 top-[72px] bg-light-surface dark:bg-[#0A0E1A] z-45 border-t border-light-border dark:border-slate-800/80 px-6 py-8 flex flex-col gap-6 md:hidden"
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
          >
            <a href="#features" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-light-text-secondary hover:text-light-text-primary dark:text-slate-300 dark:hover:text-white transition py-2 border-b border-light-border dark:border-slate-900">Features</a>
            <a href="#showcase" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-light-text-secondary hover:text-light-text-primary dark:text-slate-300 dark:hover:text-white transition py-2 border-b border-light-border dark:border-slate-900">App Preview</a>
            <a href="#roadmap" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-light-text-secondary hover:text-light-text-primary dark:text-slate-300 dark:hover:text-white transition py-2 border-b border-light-border dark:border-slate-900">Roadmap</a>
            <a href="#project-status" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-light-text-secondary hover:text-light-text-primary dark:text-slate-300 dark:hover:text-white transition py-2 border-b border-light-border dark:border-slate-900">Development Status</a>
            <button 
              onClick={() => setIsDark(!isDark)}
              className="flex items-center justify-between text-lg font-medium text-light-text-secondary hover:text-light-text-primary dark:text-slate-300 dark:hover:text-white transition py-2 border-b border-light-border dark:border-slate-900"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="mt-4 w-full py-3.5 rounded-xl text-center font-semibold bg-[#4F8EF7] hover:bg-blue-500 text-white flex items-center justify-center gap-1.5 shadow-lg shadow-blue-500/25"
            >
              Open Web Portal
              <ArrowUpRight className="w-4 h-4" />
            </a>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-b from-[#0A0E1A] to-[#0F1829] text-slate-100 overflow-hidden border-b border-light-border dark:border-slate-800">
        <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[80%] bg-blue-600/15 rounded-full blur-[120px] pointer-events-none z-0" />
        <div className="absolute top-[20%] right-[-10%] w-[50%] h-[60%] bg-purple-600/15 rounded-full blur-[120px] pointer-events-none z-0" />
        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-28 z-10 px-6 max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          >
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="px-8 py-4 rounded-2xl text-center font-bold bg-[#4F8EF7] hover:bg-blue-500 text-white shadow-xl shadow-blue-500/20 flex items-center justify-center gap-2 hover:scale-[1.02] transition-all"
            >
              Access Web Platform
            ...
            <a 
              href="#roadmap"
              className="px-8 py-4 rounded-2xl text-center font-semibold bg-white/5 backdrop-blur border border-white/10 hover:bg-white/10 hover:border-white/20 text-slate-200 flex items-center justify-center gap-1.5 transition-all shadow-none"
            >
              Explore Roadmap
            </a>
          </motion.div>
      ...
      <section id="showcase" className="py-24 border-t border-light-border dark:border-slate-900 relative z-10 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left flex flex-col items-start">
            <div className="px-3 py-1 rounded-full bg-light-surface-variant dark:bg-purple-500/10 border border-light-border dark:border-purple-500/20 text-light-text-primary dark:text-purple-400 text-xs font-semibold uppercase tracking-wider mb-4">
              <span className="text-[#4F8EF7] dark:text-purple-400 mr-1.5">•</span>
              Dashboard Insight
            </div>
            ...
            <div className="space-y-6 w-full">
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-light-surface-variant dark:bg-blue-500/15 border border-light-border dark:border-blue-500/25 rounded-xl text-[#4F8EF7] dark:text-blue-400 mt-0.5">
              ...
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-light-surface-variant dark:bg-indigo-500/15 border border-light-border dark:border-indigo-500/25 rounded-xl text-[#4F8EF7] dark:text-indigo-400 mt-0.5">
              ...
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-light-surface-variant dark:bg-purple-500/15 border border-light-border dark:border-purple-500/25 rounded-xl text-[#4F8EF7] dark:text-purple-400 mt-0.5">
      ...
      <section id="roadmap" className="py-24 border-t border-light-border dark:border-slate-900 relative z-10 px-6 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-light-surface-variant dark:bg-indigo-500/10 border border-light-border dark:border-indigo-500/20 text-light-text-primary dark:text-indigo-400 text-xs font-semibold uppercase tracking-wider mb-4">
            <Clock className="w-3.5 h-3.5 text-[#4F8EF7] dark:text-indigo-400" />
            Project Roadmap
          </div>
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4 font-display">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-left">
              ...
              <div className="p-5 bg-light-surface-variant border border-light-border dark:bg-blue-500/5 dark:border-blue-500/10 rounded-2xl mb-8">
                <h4 className="text-sm font-bold text-[#4F8EF7] dark:text-blue-400 mb-1">Ongoing Project Note</h4>
            ...
            <div className="lg:col-span-6 flex flex-col gap-4">
              <div className="p-6 rounded-2xl bg-light-surface dark:bg-slate-900/40 border border-light-border dark:border-slate-850 text-left dark:shadow-none">
                <div className="p-3 bg-light-surface-variant border border-light-border dark:bg-blue-500/10 dark:border-blue-500/20 rounded-xl text-[#4F8EF7] dark:text-blue-400 w-fit mb-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Monitor className="w-5 h-5 text-[#4F8EF7] dark:text-blue-400" />
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Smartphone className="w-5 h-5 text-[#4F8EF7] dark:text-emerald-400" />
